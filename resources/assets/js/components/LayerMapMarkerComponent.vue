      ...
      <div class="col-md-12">
        ...
        <div class="panel">
          ...
          <table class="table table-bordered tbl-regist tbl-stripe">
            ...
            <tr>
              <td>カテゴリー名<span class="label label-danger pull-right">必須</span></td>
              <td>
        ...
        <div class="panel">
          ...
          <table class="table table-bordered tbl-regist tbl-stripe">
            ...
            <tr v-if="columnData.length > 0" >
              <td>サブカテゴリー</td>
              <td>
                <select v-model="subCategory" class="form-control">
                  <option value="">--</option>
                  <option v-for="(column, index) in columnData" :id="index" :value="index">
                    {{ column.colTitle }}
                  </option>
    ...
    export default {
      ...
      mounted() {
        ...
        if (graph.managedData) {
          ...
          this.subCategory = graph.managedData.subCategory
