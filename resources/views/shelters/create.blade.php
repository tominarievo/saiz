    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          @if (filled($from))
          <div class="col-2">
            <a href="{{ route('reports.create') }}" class="btn btn-default"><i class="fas fa-arrow-left"></i> 日報登録に戻る</a>
          </div><!-- /.col -->
          @endif
    ...
    <!-- ROW -->
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          {!! Form::model($shelter, ['route' => ['shelters.store', $shelter->id], 'class' => 'form-horizontal']) !!}
