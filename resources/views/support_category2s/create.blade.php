        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">支援種別(中)
                新規作成
              </h3>
            </div>

          {!! Form::model($support_category2, ['route' => ['support_category2s.store'], 'class' => 'form-horizontal']) !!}
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  {{ $support_category2->supportCategory1->name }}

                  {{-- 支援種別(大) --}}
                  {!! Form::hidden("support_category1_id", null) !!}
