...
@section('content')
  ...
  <!-- MAIN CONTENT -->
    ...
    <div class="container-fluid">
      ...
      {!! Form::model($condition, ['route' => ['organization_views.index'], 'id' => 'search_form' ,'class' => 'form-horizontal', 'method' => 'GET']) !!}
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    {{ Form::select('organization_id', $organizations, null, ['id' => "organization_id", 'class' => 'form-control select2', 'placeholder' => "選択してください"]) }}
      ...
      $("#ganttChart").gantt({
        ...
        onAddClick: function(dt, rowId) {
          ...
          if (confirm("予定を追加しますか？")) {
            location.href = "{{ route("plans.create") }}?from_page=organization_view&from="+dateString+"&organization_id={{ $condition->organization_id }}"
            return;
          }
        },
        onRender: function() {
